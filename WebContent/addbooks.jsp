...
<header>
				...
				<ul>
					...
					<div class="login-div">
						...
						<table>
							...
							<td> <input type="text" name="id"  placeholder="Book Id"/> </td>
							</tr> -->
							<tr>
								<td> <label>Book Name :</label> </td>
								<td> <input type="text" name="book" placeholder="Book Name" required/> </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td> <input type="text" name="Qnt" placeholder="Quantity" required/> </td>
							</tr>
		...
		<div class="button">
				...
				<a class="btn" id="active" onclick="page()" href="addbooks">Add Books</a>
				<a class="btn" onclick="page()" href="delete">Delete Books</a>
